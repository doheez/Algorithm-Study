...
2. 매주 3개의 문제를 풀이
3. 본인 코드 설명은 `readme.md`에 기록
4. 다른 사람의 코드를 보고 코드 리뷰 할 것이 있으면 PR에 코멘트 남기기
<br>
...
## 📘 컨벤션
- 다같이 모여서 문제 정했을 때 문제폴더 미리 만들어놓고, 거기에서 각자 브랜치 파기
- pr 제목: week1-doheez
- 커밋 메세지: Create 0001 벽돌깨기
- 수정할때 커밋메세지: Modify 0001 벽돌깨기
- 회의 시작 시 PR 머지 하고 시작
